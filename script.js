...
var resultTemplate = `<li class="result-item">
<div class="cover-bg" style="background-image:url(\'ARTWORK_URL\');"></div>
<img src="ARTWORK_URL" alt="TRACK_NAME album artwork" title="TRACK_NAME by ARTIST_NAME" />
<h2>TRACK_NAME</h2>
<h3>ARTIST_NAME</h3>
<audio src="PREVIEW_URL" controls="controls" preload="none"></audio></li>`;
